...
# chrome_options.add_argument('--proxy-server=191.209.72.68:53281')
...
driver = webdriver.Chrome(executable_path=executable_path,chrome_options=chrome_options) #, chrome_options=chrome_options
# time.sleep(30)
...
def searchPageByPage(keyword,i):  
    if(i==0):     
        if(ele.checkexistancebyxpath('//*[@id="lst-ib"]',driver)):#ele.checkexistancebyxpath('//*[@id="lst-ib"]',driver)
            ...
            if(ele.checkexistancebyxpath('//*[@id="tsf"]/div[2]/div[3]/center/input[1]',driver)):
